...
echo_y "${ctl_A} ip route add 10.10.10.0/24 via fdab::1"
$ctl_A ip route add 10.10.10.0/24 via fdab::1
echo_y "$ctl_A ip route add fdab::/96 via 10.10.10.1"
$ctl_A ip route add fdab::/96 via 10.10.10.1
$ctl_A show int address
...
echo_g "set route rules"
echo_y "${ctl_B} ip route add 10.10.1.0/24 via fdab::2"
$ctl_B ip route add 10.10.1.0/24 via fdab::2
echo_y "$ctl_B ip route add fdab::/96 via 10.10.1.1"
$ctl_B ip route add fdab::/96 via 10.10.1.1
$ctl_B show int address
# --------------------------
# vCPEA
# --------------------------
